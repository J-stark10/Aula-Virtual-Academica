...
def listar():
    ...
    return render_template("categoria/categorias_listar.html", items=items)
...
def crear():
    ...
    return render_template("categoria/categorias_crear.html")
...
def editar(id):
    ...
    return render_template("categoria/categorias_editar.html", item=item)
